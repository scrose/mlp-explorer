...
exports.edit = async (req, res, next) => {
  await surveyors
    .findById(req.params.surveyors_id)
    .then((result) => {
      res.statusCode = 200;
...
exports.create = [
  ...
  (req, res, next) => {
    ...
    var surveyor = new Surveyor({ name: req.body.name });
