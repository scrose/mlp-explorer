/*!
 * MLP.Client.Components.IAT.Loader
 * File: loader.iat.js
...
export const CaptureLoaderIat = ({ id = null, callback = () => {}, cancel = () => {} }) => {
    ...
    const _handleSubmit = () => {
        ...
        // - if in toolkit mode, load directly to canvas
        // - otherwise, redirect with query params
        window.location.pathname === '/iat'
            ? iat.setInputParams(params)
            : redirect(createRoute('/iat', params));
    };
